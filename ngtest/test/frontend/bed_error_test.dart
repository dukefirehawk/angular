...
void main() {
  ...
  test(
    'should be able to catch errors that occur synchronously',
    CatchSynchronousErrors._runTest,
  );

  test(
    'should be able to catch errors that occur asynchronously',
    CatchAsynchronousErrors._runTest,
  );

  test(
    'should be able to catch errors that occur in the constructor',
    CatchConstructorErrors._runTest,
  );

  test(
    'should be able to catch errors asynchronously in constructor',
    CatchConstructorAsyncErrors._runTest,
  );

  test(
    'should be able to catch asynchronous errors from a native event',
    CatchNativeEventAsynchronousErrors._runTest,
  );

  test(
    'should be able to catch synchronously errors from a native event',
    CatchNativeEventSynchronousErrors._runTest,
  );

  test(
    'should be able to catch errors that occur in `ngOnInit`',
    CatchOnInitErrors._runTest,
  );

  test(
    'should be able to catch errors that occur in change detection',
